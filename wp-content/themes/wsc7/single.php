            ...
            <div id="page_main" class="col-md-9">
                <section id="kiji_sum" class="shadow curve">
                    ...
                    <div class="kiji_text">
                        ...
                        <?php if($cat == 'scp'): ?>
                            <?php if($accounttype0 == 'sc' || $accounttype1 == 'sc' || $accounttype2 == 'sc' || $accounttype3 == 'sc'): ?>
                                <p><?php the_content(); ?></p>
                                </div>
                                </section>
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                        <?php elseif ($cat == 'ostp'): ?>
                            <?php if($accounttype0 == 'ost' || $accounttype1 == 'ost' || $accounttype2 == 'ost' || $accounttype3 == 'ost'): ?>                
                                <p><?php the_content(); ?></p>
                                </div>
                                </section>
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                        <?php elseif ($cat == 'eurp'): ?>
                            <?php if($accounttype0 == 'eu' || $accounttype1 == 'eu' || $accounttype2 == 'eu' || $accounttype3 == 'eu'): ?>                
                                <p><?php the_content(); ?></p>
                                </div>
                                </section>
                            <?php else: ?>
                                ...
                                <?php echo do_shortcode('[contact-form-7 id="1391" title="ニューズレター申し込み"]'); ?>
                            <?php endif; ?>
                        <?php elseif ($cat == 'autop'): ?>
                            <?php if($accounttype0 == 'auto' || $accounttype1 == 'auto' || $accounttype2 == 'auto' || $accounttype3 == 'auto'): ?>                
                                <p><?php the_content(); ?></p>
                                </div>
                                </section>
                            <?php else: ?>
